...
export default {
  ...
  compliance: {
    ...
    'opt-in':
      '{{messagelink}}<div class="cc-compliance cc-highlight">{{deny}}{{allow}}{{customize}}</div>',
    'opt-out':
      '{{messagelink}}<div class="cc-compliance cc-highlight">{{dismiss}}{{deny}}</div>',
  ...
  layouts: {
    ...
    'basic-header': '{{header}}{{compliance}}'
